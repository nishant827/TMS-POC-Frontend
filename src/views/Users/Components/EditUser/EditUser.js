...
function Edituser(props) {
  ...
  const onChange = (e) => {
   ...
   let selectedRole,selectedGender;
  if (user.role === "ZH") {
    selectedRole="ZonalHead" ;
    ...
    <div className="app flex-row align-items-center">
      ...
      <Container>
        ...
        <Row className="justify-content-center">
          ...
          <Col md="12" lg="10" xl="8" style={{"maxWidth":"50.666667"}}>

            <Card className="mx-4" style={{"marginTop": "-27px"}}>
              ...
              <CardBody className="p-4">
                ...
                <Form onSubmit={Updateuser}>
                  ...
                  <InputGroup className="mb-4">
                    ...
                    <select>
                      {selectedGender ? <option value="">{selectedGender} </option> : (
                        <option value=""></option>
                      )}
                    </select>
                  ...
                  <InputGroup className="mb-4">
                    ...
                    <select>
                      {selectedRole ? <option value="">{selectedRole} </option> : (
                        <option value=""></option>
                      )}
                    </select>
                  ...
                  <CardFooter className="p-4">
                    ...
                    <Row>
                      ...
                      <Col xs="12" sm="6">
                        ...
                        <Button className="btn btn-info mb-1" onClick={redirect} block ><span>Cancel</span></Button>
